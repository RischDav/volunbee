...
ActiveRecord::Schema[7.2].define(version: 2024_12_08_150318) do
  ...
  create_table "positions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["organisation_id"], name: "index_positions_on_organisation_id"
  end

  add_foreign_key "admins", "organizations", column: "organisation_id"
  add_foreign_key "images", "positions"
  add_foreign_key "messages", "positions"
  add_foreign_key "positions", "organizations", column: "organisation_id"
end
